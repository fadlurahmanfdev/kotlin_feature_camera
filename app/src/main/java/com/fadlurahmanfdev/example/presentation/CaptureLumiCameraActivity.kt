...
class CaptureLumiCameraActivity : LumiLumiCameraActivity(), LumiLumiCameraActivity.CameraListener {
        ...
        ivCamera.setOnClickListener {
            takePicture(object : LumiCameraCaptureListener {
                override fun onCaptureSuccess(
                    ...
                    val intent =
                        Intent(this@CaptureLumiCameraActivity, PreviewImageActivity::class.java)
                    startActivity(intent)
                }

                override fun onCaptureError(exception: FeatureCameraException) {
                    Toast.makeText(this@CaptureLumiCameraActivity, "Capture Error: ${exception.enumError}", Toast.LENGTH_SHORT).show()
                }
            })
        }
